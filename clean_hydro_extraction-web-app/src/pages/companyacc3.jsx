    ...
    <div className="client-acc-wrapper">
      ...
      <div className="client-body">
        ...
        <main className="info-content">
          ...
          <InfoCard label="Product preferences" value="Customize product features, themes, or layout settings." />
            <InfoCard label="Usage Reports" value="See insights or statistics related to your usage." />
          </div>
        </main>
      </div>
    </div>
